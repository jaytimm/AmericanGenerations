...
> **U.S. Census Bureau.** (2023). *Monthly Population Estimates by Age, Sex, Race, and Hispanic Origin for the United States: April 1, 2020, to July 1, 2023 (with short-term projections to December 2024).* National population estimates. U.S. Department of Commerce. Retrieved from https://www.census.gov
...
setwd('/home/jtimm/pCloudDrive/GitHub/git-projects/AmericanGenerations/data')
write.csv(gen_pops1, 'cleaned_data.csv', row.names = F)
```
